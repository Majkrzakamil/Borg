...
export const HistoricalPriceProvider: React.FC<HistoricalPriceProviderProps> = ({ children, initialData }) => {
  const [period, setPeriod] = useState<Period>('day');
  const [data, setData] = useState<HistoricalPrice[] | null>(initialData);
