...
const SEO: React.FC<SEOProps> = ({ title, description, image, url, twitterUsername }) => {
  ...
  `)
	...
	const defaultImageData = file ? getImage(file.childImageSharp.gatsbyImageData) : null
	...
	return (
		<>
			...
			{!image && defaultImageData && <GatsbyImage image={defaultImageData} alt="OpenGraph Image" style={{ display: 'none' }} />}
		</>
	)
}
